function AnalysisFigure = Matching_MS_MLE_ChoiceSymmetricQLearningNoMemory_Diagnosis(DataFolderPath)
% MS = MultiSession
...
% bias
SessionBiasMLEAxes = axes(AnalysisFigure, 'Position', [0.35    0.50    0.64    0.10]);
...
for iSession = 1:length(DataHolder)
    ...
    BiasMLEs(iSession) = Model.EstimatedParameters(4);
