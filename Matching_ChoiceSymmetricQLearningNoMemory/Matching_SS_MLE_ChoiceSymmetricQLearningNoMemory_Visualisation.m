function AnalysisFigure = Matching_SS_MLE_ChoiceSymmetricQLearningNoMemory_Visualisation(DataFile, Model)
% SS = SingleSession
...
AnalysisName = 'Matching_SS_MLE_ChoiceSymmetricQLearningNoMemory';
...
if ~all(isnan(FeedbackWaitingTime))
    ...
    set(ValueTIGLMAxes,...
        ...
        'XLim', [0, 5],...
        'XTick', [1, 2, 3, 4],...
        'XTickLabel', {'\beta_0', 'Q_{chosen}', 'Q_{unchosen}'},...
...
DataPath = strcat(DataFolder, RatName, '\bpod_session\', SessionDateTime, '\',...
                  RatName, '_TwoArmBanditVariant_', SessionDateTime, '_Matching_ChoiceSymmetricQLearningNoMemory.png');
