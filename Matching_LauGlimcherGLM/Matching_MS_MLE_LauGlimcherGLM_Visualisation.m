function AnalysisFigure = Matching_MS_MLE_LauGlimcherGLM_Visualisation(DataFolderPath)
% MS = MultiSession
...
AnalysisName = 'Matching_MS_MLE_LauGlimcherGLM';
...
try
    ...
    for iSession = 1:length(DataHolder)
        ...
        try
            Models{iSession} = Matching_SS_MLE_LauGlimcherGLM_Model(SessionData);
        catch
            Models{iSession} = [];
