...
SamplerInitialHyperParameters = [0.25, 0.25, 16,... % LearningRate, Mu, Kappa
                                 8, 8, 1,...        % InverseTemperature, Mean, Sigma
                                 1/6, 1/6, 12,...   % ForgettingRate, Mu, Kappa
                                 -1, -1, 1,...      % ChoiceStickiness, Mean, Sigma
                                 5/8, 5/8, 16,...   % ChoiceForgettingRate, Mu, Kappa
                                 0, 0, 1]';         % Bias, Mean, Sigma
