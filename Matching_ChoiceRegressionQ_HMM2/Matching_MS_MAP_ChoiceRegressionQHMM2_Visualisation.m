function AnalysisFigure = Matching_MS_MAP_ChoiceRegressionQHMM2_Visualisation(DataFolderPath)
% MS = MultiSession
...
try
    ...
    for iSession = 1:length(DataHolder)
        ...
        try
            Models{iSession} = Matching_SS_MAP_ChoiceRegressionQHMM2_Model(SessionData);
        catch
            Models{iSession} = [];
