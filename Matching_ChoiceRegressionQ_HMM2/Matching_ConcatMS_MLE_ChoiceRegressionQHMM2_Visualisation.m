function AnalysisFigure = Matching_ConcatMS_MLE_ChoiceRegressionQHMM2_Visualisation(DataFolderPath)
% ConcatMS = MultiSession concatenated as one session
...
try
    ...
    load(fullfile(DataFolderPath, '\Concatenated_Data.mat')); % variable name = 'SessionData'
catch
...
AnalysisName = 'Matching_ConcatMS_MLE_ChoiceRegressionQHMM2';
...
try
    ...
    try
        AnalysisFunction = str2func(strcat(AnalysisName, '_Model'));
        Model = AnalysisFunction(SessionData);
    catch
        disp('Error: Problem running model for the concatenated Session')
        return
    end
