...
for iSession = 1:length(DataHolder)
    ...
    % choice stickiness
    ChoiceStickinessChainSwarmchart(iSession) = swarmchart(SessionChoiceStickinessMAPAxes,...
    ...
    ChoiceStickinessChainHDILine(iSession) = line(SessionChoiceStickinessMAPAxes,...
                                                      [iSession, iSession],...
    ...
    % choice forgetting rate
    ChoiceForgettingRateChainSwarmchart(iSession) = swarmchart(SessionChoiceForgettingRateMAPAxes,...
    ...
    ChoiceForgettingRateChainHDILine(iSession) = line(SessionChoiceForgettingRateMAPAxes,...
                                                      [iSession, iSession],...
    ...
    % bias
    BiasChainSwarmchart(iSession) = swarmchart(SessionBiasMAPAxes,...
    ...
    BiasChainHDILine(iSession) = line(SessionBiasMAPAxes,...
                                      [iSession, iSession],...
