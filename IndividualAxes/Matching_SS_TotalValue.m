...
TotalValuePlot = plot(BlockSwitchAxes, 1:nTrials, LeftValue+RightValue,...
                      'LineStyle', '-',...
...
ylabel(BlockSwitchAxes,'sum(Q)')

saveas(AnalysisFigure, strcat(RatName, '_', SessionDateTime, '_Matching_TotalValue'), 'svg')
end