function AnalysisFigure = Matching_MS_PL_BackgroundDA_ChosenValue(DataFolderPath, PhotometryDatasetFilePath, ModelsFilePath, FigureSize, AxeSize)
...
AnalysisName = 'Matching_MS_PL_BackgroundDA_ChosenValue';
...
BackgroundDAChosenValueScatter = scatter(BackgroundDAChosenValueAxes, ChosenValue(ValidIdx), dFEstimation(ValidIdx),...
                                         'Marker', '.',...
                                         'MarkerEdgeColor', 'k',...
                                         'SizeData', 1);
...
X = [ones(1, sum(ValidIdx)); ChosenValue(ValidIdx)]';
