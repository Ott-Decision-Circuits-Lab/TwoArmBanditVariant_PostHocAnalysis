function AnalysisFigure = Matching_MS_PL_BackgroundDA_ChosenValue_RewardRate_Mediation(DataFolderPath, PhotometryDatasetFilePath, ModelsFilePath, FigureSize, AxeSize)
...
AnalysisName = 'Matching_MS_PL_BackgroundDA_ChosenValue_RewardRate_Mediation';
...
% text
XDataName = 'V_{chosen}';
MDataName = 'Reward rate';
YDataName = 'dF/F';
XData = ChosenValue;
MData = TotalValue;
YData = dFEstimationZScore;
...
% a*b
ab = a*b;
abError = ab * sqrt((aError/a)^2 + (bError/b)^2);
