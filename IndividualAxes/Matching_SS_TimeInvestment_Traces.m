function AnalysisFigure = Matching_SS_TimeInvestment_Traces(DataFile, FigureSize, AxeSize)
...
if ~isempty(ChoiceLeft) && ~all(isnan(ChoiceLeft))
    ...
    TrialLeftTIPlot = plot(TracesAxes, idxTrial(LeftTITrial), LeftTI,...
                           'LineStyle', 'none',...
                           'Marker', '.',...
                           'MarkerSize', 10,...
                           'MarkerEdgeColor', ColourPalette.Left);
    
    TrialRightTIPlot = plot(TracesAxes, idxTrial(RightTITrial), RightTI,...
                            'LineStyle', 'none',...
                            'Marker', '.',...
                            'MarkerSize', 10,...
                            'MarkerEdgeColor', ColourPalette.Right);
    
    LRVevaiometryLegend = legend(TracesAxes, {'Left', 'Right'},...
                                 'Box', 'off',...
                                 'Position', [ 3.88  2.78,  2.3,  0.6],...
                                 'NumColumns', 2,...
                                 'Units', 'inches',...
                                 'Color', 'none',...
                                 'Box', 'off');

    set(LRVevaiometryLegend,... % 'Interpreter', 'latex',...
        'Position', [ 3.88  2.78,  2.3,  0.6],...
        'Units', 'inches');
...
exportgraphics(AnalysisFigure, strcat(RatName, '_', SessionDateTime, '_Matching_TimeInvestment_Traces.pdf'), 'ContentType', 'vector', 'Resolution', 300)
end