...
BackgroundDATotalValueScatter = scatter(BackgroundDATotalValueAxes, LeftValue + RightValue, dFEstimation,...
                                        'Marker', '.',...
                                        'MarkerEdgeColor', 'k',...
                                        'SizeData', 1);

[RValue, pValue] = corrcoef(LeftValue + RightValue, dFEstimation);
...
X = [ones(1, nTrials); LeftValue + RightValue]';
b = X \ dFEstimation';
...
set(BackgroundDATotalValueAxes,...
    ...
    'YTick', [-20, 0, 20],...
    'FontSize', 12);
xlabel(BackgroundDATotalValueAxes, 'sum(Q) (a.u.)')
ylabel(BackgroundDATotalValueAxes, sprintf('Baseline dopamine (dF/F)'))

saveas(AnalysisFigure, strcat(RatName, '_', SessionDateTime, '_Matching_BackgroundDA_TotalValue'), 'svg')
end