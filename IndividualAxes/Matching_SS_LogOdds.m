function AnalysisFigure = Matching_SS_LogOdds(DataFile, Model, FigureSize, AxeSize)
...
LogOddsPlot = plot(BlockSwitchAxes, 1:nTrials, movmean(LogOdds, 3),...
                   'LineStyle', '-',...
...
exportgraphics(AnalysisFigure, strcat(RatName, '_', SessionDateTime, '_Matching_LogOdds.pdf'), 'ContentType', 'vector', 'Resolution', 300)
end