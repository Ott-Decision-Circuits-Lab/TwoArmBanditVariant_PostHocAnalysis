function AnalysisFigure = Matching_SS_MLE_ChoiceForagingRewardRate_Visualisation(DataFile, Model)
% SS = SingleSession
...
AnalysisName = 'Matching_SS_MLE_ChoiceForagingRewardRate';
...
if nargin < 2
    try
        Model = Matching_SS_MLE_ChoiceForagingRewardRate_Model(SessionData);
    catch
...
BackgroundRewardRate = Values.BackgroundRewardRate;
...
BackgroundRewardRateWeightText = text(ModelParameterAxes, 0, 3,...
                                      strcat('\theta = ', sprintf('%5.3f', BackgroundRewardRateWeight)),...
                                      'FontSize', 12,...
                                      'Interpreter', 'tex');
...
BackgroundRewardRateDecayConstantText = text(ModelParameterAxes, 0, 1,...
                                             strcat('\theta = ', sprintf('%5.3f', BackgroundRewardRateDecayConstant)),...
                                             'FontSize', 12,...
                                             'Interpreter', 'tex');
