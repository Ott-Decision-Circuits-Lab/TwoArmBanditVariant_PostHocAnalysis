...
MLEAxes = axes(AnalysisFigure, 'Position', [0.22    0.75    0.15    0.19]);
hold(MLEAxes, 'on');
...
set(MLEAxes,...
    ...
    'YLim', [0, 12],...
    'YAxisLocation', 'right')
xlabel(MLEAxes, 'Parameters');
ylabel(MLEAxes, 'Estimate (a.u.)');
title(MLEAxes, 'Maximum likelihood estimation')
...
% Posterior mode (i.e. MAP, maximum a posteriori) estimate of ChoiceSymmetricQ
XData = 1 * ones(size(LearningRateMLEs));
LearningRateSwarmchart = swarmchart(MLEAxes,...
                                    XData,...
                                    LearningRateMLEs,...
                                    'Marker', '.',...
...
LearningRateBoxchart = boxchart(MLEAxes, XData, LearningRateMLEs);
...
XData = 2 * ones(size(InverseTemperatureMLEs));
InverseTemperatureSwarmchart = swarmchart(MLEAxes,...
                                          XData,...
                                          InverseTemperatureMLEs,...
                                          'Marker', '.',...
                                          'MarkerEdgeColor', ColourPalette.Session,...
...
InverseTemperatureBoxchart = boxchart(MLEAxes, XData, InverseTemperatureMLEs);
...
XData = 3 * ones(size(ForgettingRateMLEs));
ForgettingRateSwarmchart = swarmchart(MLEAxes,...
                                      XData,...
                                      ForgettingRateMLEs,...
                                      'Marker', '.',...
                                      'MarkerEdgeColor', ColourPalette.Session,...
...
ForgettingRateBoxchart = boxchart(MLEAxes, XData, ForgettingRateMLEs);
...
XData = 4 * ones(size(ChoiceStickinessMLEs));
ChoiceStickinessSwarmchart = swarmchart(MLEAxes,...
                                        XData,...
                                        ChoiceStickinessMLEs,...
                                        'Marker', '.',...
                                        'MarkerEdgeColor', ColourPalette.Session,...
...
ChoiceStickinessBoxchart = boxchart(MLEAxes, XData, ChoiceStickinessMLEs);
...
XData = 5 * ones(size(ChoiceForgettingRateMLEs));
ChoiceForgettingRateSwarmchart = swarmchart(MLEAxes,...
                                            XData,...
                                            ChoiceForgettingRateMLEs,...
                                            'Marker', '.',...
                                            'MarkerEdgeColor', ColourPalette.Session,...
...
ChoiceForgettingRateBoxchart = boxchart(MLEAxes, XData, ChoiceForgettingRateMLEs);
...
XData = 6 * ones(size(BiasMLEs));
BiasSwarmchart = swarmchart(MLEAxes,...
                            XData,...
                            BiasMLEs,...
                            'Marker', '.',...
                            'MarkerEdgeColor', ColourPalette.Session,...
...
BiasBoxchart = boxchart(MLEAxes, XData, BiasMLEs);
set(BiasBoxchart,...
    'BoxWidth', 0.2,...
    'BoxFaceColor', 'k',...
    'BoxFaceAlpha', 0,...
