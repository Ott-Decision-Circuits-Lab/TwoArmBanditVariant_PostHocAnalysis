...
Block1To2Explore = nan(100, 61);
Block2To3Explore = nan(100, 61);
Block3To4Explore = nan(100, 61);
Block4To5Explore = nan(100, 61);
...
Block1To2AbsRes = nan(100, 61);
Block2To3AbsRes = nan(100, 61);
Block3To4AbsRes = nan(100, 61);
Block4To5AbsRes = nan(100, 61);
...
for iSession = 1:length(DataHolder)
    ...
    Block1To2Explore(iSession, :) = AbsModelResiduals(BlockTransitionIdx - 10:BlockTransitionIdx + 50) >= 0.5;
    Block1To2AbsRes(iSession, :) = AbsModelResiduals(BlockTransitionIdx - 10:BlockTransitionIdx + 50);

    % Block 2 transition (2nd -> 3rd)
    BlockTransitionIdx = find(BlockTrialNumber == 1 & BlockNumber == 3);
    Block2To3Explore(iSession, :) = AbsModelResiduals(BlockTransitionIdx - 10:BlockTransitionIdx + 50) >= 0.5;
    Block2To3AbsRes(iSession, :) = AbsModelResiduals(BlockTransitionIdx - 10:BlockTransitionIdx + 50);
    ...
    if ~isempty(BlockTransitionIdx) & BlockTransitionIdx + 50 <= nTrials
        Block3To4Explore(iSession, :) = AbsModelResiduals(BlockTransitionIdx - 10:BlockTransitionIdx + 50) >= 0.5;
        Block3To4AbsRes(iSession, :) = AbsModelResiduals(BlockTransitionIdx - 10:BlockTransitionIdx + 50);
    end

    % Block 4 transition (4th -> 5th)
    BlockTransitionIdx = find(BlockTrialNumber == 1 & BlockNumber == 5);
    if ~isempty(BlockTransitionIdx) & BlockTransitionIdx + 50 <= nTrials
        Block4To5Explore(iSession, :) = AbsModelResiduals(BlockTransitionIdx - 10:BlockTransitionIdx + 50) >= 0.5;
        Block4To5AbsRes(iSession, :) = AbsModelResiduals(BlockTransitionIdx - 10:BlockTransitionIdx + 50);
    end
...
Block1To2ExploreLine = line(BlockTransitionAxes,...
                            'xdata', -10:50,...
                            'ydata', movmean(Block1To2ExploreMean, 9) * 100,...
                            'LineStyle', '-',...
                            'Marker', 'none',...
                            'Color', 0.0 * [1 1 1]);
...
Block2To3ExploreLine = line(BlockTransitionAxes,...
                            'xdata', -10:50,...
                            'ydata', movmean(Block2To3ExploreMean, 9) * 100,...
                            'LineStyle', '-',...
                            'Marker', 'none',...
                            'Color', 0.2 * [1 1 1]);
...
Block3To4ExploreLine = line(BlockTransitionAxes,...
                            'xdata', -10:50,...
                            'ydata', movmean(Block3To4ExploreMean, 9) * 100,...
                            'LineStyle', '-',...
                            'Marker', 'none',...
                            'Color', 0.4 * [1 1 1]);
...
Block4To5ExploreLine = line(BlockTransitionAxes,...
                            'xdata', -10:50,...
                            'ydata', movmean(Block4To5ExploreMean, 9) * 100,...
                            'LineStyle', '-',...
                            'Marker', 'none',...
                            'Color', 0.6 * [1 1 1]);
...
Block1To2AbsResLine = line(BlockTransitionAbsResAxes,...
                           'xdata', -10:50,...
                           'ydata', movmean(Block1To2AbsResMean, 9),...
                           'LineStyle', '-',...
                           'Marker', 'none',...
                           'Color', 0.0 * [1 1 1]);
...
Block2To3AbsResLine = line(BlockTransitionAbsResAxes,...
                           'xdata', -10:50,...
                           'ydata', movmean(Block2To3AbsResMean, 9),...
                           'LineStyle', '-',...
                           'Marker', 'none',...
                           'Color', 0.2 * [1 1 1]);
...
Block3To4AbsResLine = line(BlockTransitionAbsResAxes,...
                           'xdata', -10:50,...
                           'ydata', movmean(Block3To4AbsResMean, 9),...
                           'LineStyle', '-',...
                           'Marker', 'none',...
                           'Color', 0.4 * [1 1 1]);
...
Block4To5AbsResLine = line(BlockTransitionAbsResAxes,...
                           'xdata', -10:50,...
                           'ydata', movmean(Block4To5AbsResMean, 9),...
                           'LineStyle', '-',...
                           'Marker', 'none',...
                           'Color', 0.6 * [1 1 1]);
