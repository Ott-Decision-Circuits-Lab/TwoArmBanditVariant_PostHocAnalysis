...
Block1To2ExploreLine = line(BlockTransitionAxes,...
                            'xdata', -10:50,...
                            'ydata', smooth(Block1To2ExploreMean) * 100,...
                            'LineStyle', '-',...
                            'Marker', 'none',...
                            'Color', 0.0 * [1 1 1]);
...
Block2To3ExploreLine = line(BlockTransitionAxes,...
                            'xdata', -10:50,...
                            'ydata', smooth(Block2To3ExploreMean) * 100,...
                            'LineStyle', '-',...
                            'Marker', 'none',...
                            'Color', 0.2 * [1 1 1]);
...
Block3To4ExploreLine = line(BlockTransitionAxes,...
                            'xdata', -10:50,...
                            'ydata', smooth(Block3To4ExploreMean) * 100,...
                            'LineStyle', '-',...
                            'Marker', 'none',...
                            'Color', 0.4 * [1 1 1]);
...
Block4To5ExploreLine = line(BlockTransitionAxes,...
                            'xdata', -10:50,...
                            'ydata', smooth(Block4To5Explore) * 100,...
                            'LineStyle', '-',...
                            'Marker', 'none',...
                            'Color', 0.6 * [1 1 1]);
...
Block1To2AbsResLine = line(BlockTransitionAbsResAxes,...
                           'xdata', -10:50,...
                           'ydata', smooth(Block1To2AbsResMean),...
                           'LineStyle', '-',...
                           'Marker', 'none',...
                           'Color', 0.0 * [1 1 1]);
...
Block2To3AbsResLine = line(BlockTransitionAbsResAxes,...
                           'xdata', -10:50,...
                           'ydata', smooth(Block2To3AbsResMean),...
                           'LineStyle', '-',...
                           'Marker', 'none',...
                           'Color', 0.2 * [1 1 1]);
...
Block3To4AbsResLine = line(BlockTransitionAbsResAxes,...
                           'xdata', -10:50,...
                           'ydata', smooth(Block3To4AbsResMean),...
                           'LineStyle', '-',...
                           'Marker', 'none',...
                           'Color', 0.4 * [1 1 1]);
...
Block4To5AbsResLine = line(BlockTransitionAbsResAxes,...
                           'xdata', -10:50,...
                           'ydata', smooth(Block4To5AbsResMean),...
                           'LineStyle', '-',...
                           'Marker', 'none',...
                           'Color', 0.6 * [1 1 1]);
